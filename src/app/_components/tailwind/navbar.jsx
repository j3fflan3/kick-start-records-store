...
export function Navbar({ className, ...props }) {
  return (
    <nav
      ...
      className={clsx(
        className,
        "flex flex-1 items-center gap-4 py-2.5 bg-yellow-500 dark:bg-primary-950"
      )}
    />
  );
}
...
export const NavbarItem = forwardRef(function NavbarItem(
  ...
  let classes = clsx(
    // Base
    "relative flex min-w-0 items-center gap-4 rounded-lg p-2 text-left !text-lg/6 font-medium text-zinc-950 sm:text-sm/5",
