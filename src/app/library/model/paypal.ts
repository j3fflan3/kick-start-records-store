...
// PayPal Capture Order API response types
interface PayPalCaptureCapture {
  id: string;
  status: string;
  invoice_id: string;
  custom_id: string;
...
interface PayPalCapturePayments {
  captures: PayPalCaptureCapture[];
}

interface PayPalCaptureShipping {
  name: Nullable<{ full_name: string }>;
  email_address: Nullable<string>;
}

interface PayPalCapturePurchaseUnit {
  reference_id: string;
  shipping: Nullable<PayPalCaptureShipping>;
  payments: PayPalCapturePayments;
}

interface PayPalCapturePaymentSource {
  card?: Nullable<{ name: Nullable<string> }>;
  paypal?: Nullable<unknown>;
  venmo?: Nullable<unknown>;
}
...
interface PayPalCaptureResponse {
  ...
  payment_source: PayPalCapturePaymentSource;
}
...
export {
  ...
  type PayPalCapturePaymentSource,
};
