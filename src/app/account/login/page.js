    ...
    <div>
      <div className="relative flex grid-cols-3">
        ...
        <div className="text-center rounded-md py-4 w-1/3">
          <h1 className={`text-5xl dark:text-accent-50 pb-5`}>Log In</h1>
          <p className="pb-1 dark:text-primary-200">
            New customer?{" "}
            <Link
              href="/account/verify-human"
              className="border dark:border-primary-700 py-1 px-2 rounded-md mx-2 text-lg inline-block hover:bg-accent-600 transition-all hover:text-primary-950"
            >
              Start here &rarr;
            </Link>
          </p>
          <LoginForm />
          <p className="dark:text-primary-200 pt-3">
